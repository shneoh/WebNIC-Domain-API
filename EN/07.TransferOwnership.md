...
>**Note :** <br>
>Transfer ownership is NOT applicable for offline domain name extensions such as .my, .vn, .in, .jp, .pk, .th, .au, .de, .it, .li, .nz, .uk.<br> 

**Function :** pn_newtrfown.jsp
...
domainname | R | Domain name to be transfer ownership Currently supports online/real time domain names such as .tv, .mobi, .sg, etc.
...
custom_adm3 | O | Individual <br> **Note :** Required field if register .HK, .MY <ul><li>Date of Birth (`YYYY-MM-DD`)</li></ul> **Note :** Required field if register .US <ul><li>`C12` – A permanent resident of U.S. or any U.S. territory</li><li>`C32` – An entity that has an office or facility in the U.S</li><li>`C31` – An entity that regularly engages in lawful activities</li><li>`C11` – Citizen or National of the United States</li><li>`C21` – Incorporated within one of the U.S. states or U.S. territory</li></ul>
flag_tec | O | `1` : Technical contact is same as registrant’s contact **Note :** If this parameter pass-in, field relate to technical contact is not required. Otherwise, it is a required field.
...
custom_tec1 | R | Individual: Identity Number<br> Organization: Registration Number
