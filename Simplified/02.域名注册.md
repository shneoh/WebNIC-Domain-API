...
reg_id_type | R | **注 :** 必填项目： .CN, .COM.CN, .GOV.CN, .NET.CN, .ORG.CN, .中国, .公司, .网络 <ul><li>`SFZ` - 身份证号码</li><li>`HZ` - 护照号码</li><li>`GAJMTX` - 港澳居民来往内地通行证</li><li>`TWJMTX` - 台湾居民来往大陆通行证</li><li>`WJLSFZ` - 外国人永久居留身份证</li><li>`GAJZZ` - 港澳居民居住证</li><li>`TWJZZ` - 台湾居民居留证</li><li>`JGZ` - 军官证</li><li>`QT` - 其他</li></ul>
reg_id_code | R | 身份证明号码 <br><br> **注 :** 必填项目： .CN, .COM.CN, .GOV.CN, .NET.CN, .ORG.CN, .中国, .公司, .网络
reg_org_type | R | **注 :** 必填项目： .CN, .COM.CN, .GOV.CN, .NET.CN, .ORG.CN, .中国, .公司, .网络 <ul><li>`ORG` - 组织机构代码证</li><li>`YYZZ` - 工商营业执照</li><li>`TYDM` - 统一社会信用代码证</li><li>`BDDM` - 部队代码</li><li>`JDDWFW` - 军队单位对外有偿服务许可证</li><li>`SYDWFR` - 事业单位法人证书</li><li>`WGCZJG` - 外国企业常驻代表机构登记证</li><li>`SHTTFR` - 社会团体法人登记证</li><li>`ZJCS` - 宗教活动场所登记证</li><li >`MBFQY` - 民办非企业法人登记证</li><li>`JJHFR` - 基金会法人登记证</li><li>`LSZY` - 律师事务所分支机构执业许可证</li> <li>`WGZHWH` - 外国在华文化中心登记证</li><li>`WLCZJG` - 外国政府旅游部门常驻代表机构批准登记证</li><li>`SFJD` - 司法鉴定许可证 </li><li>`JWJG` - 境外机构证件</li><li>`SHFWJG` - 社会服务机构登记证书</li><li>`MBXXBX` - 民办学校办学许可证</li><li>`YLJGZY` - 医疗机构执业许可证</li><li>`GZJGZY` - 公证机构执业证</li><li>`BJWSXX` - 北京市外国驻华使馆人员子女学校办学许可证</li><li>`QTTYDM` - 其他 - 统一社会信用代码</li><li>`SFZ` - 身份证</li><li>`HZ` - 护照</li><li>`GAJMTX ` - 港澳居民来往内地通行证</li><li>`TWJMTX` - 台湾居民来往内地通行证</li><li>`WJLSFZ` - 外国永久居民身份证</li><li >`GAJZZ` - 港澳居民居住证</li><li>`TWJZZ` - 台湾居民居住证</li><li>`JGZ` - 军官证</li><li> `QT` - 其他</li></ul>
reg_org_code | R | 组织证明编号 <br><br> **注 :** 必填项目： .CN, .COM.CN, .GOV.CN, .NET.CN, .ORG.CN, .中国, .公司, .网络
